      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <select 
            ...
            className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-xl text-slate-100 outline-none focus:border-blue-500/60 transition-all duration-300"
          >
        ...
        <button 
          disabled={loading} 
          className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white rounded-xl py-2.5 px-4 font-semibold shadow-lg shadow-blue-500/10 transition-all duration-300 active:scale-98 cursor-pointer"
        >
          Adicionar Gasto
        </button>
      </div>
